...
import java.net.URL;
public class MakeABidOnAListingTest {
  ...
  @Test
  public void makeABidOnAListing() {
    ...
    driver.findElement(By.cssSelector(".app > .css-0")).click();
    {
      WebElement element = driver.findElement(By.cssSelector(".MuiButton-root"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).perform();
    }
    driver.findElement(By.id(":r2:")).sendKeys("123");
